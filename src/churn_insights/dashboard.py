...
def main():
    st.set_page_config(page_title="Churn Insights | Retenção", page_icon="◈", layout="wide", initial_sidebar_state="collapsed")
    ...
    st.markdown('<footer><span><strong>CHURN INSIGHTS</strong> / Inteligência de retenção</span><span>Projeto demonstrativo · Python + Streamlit</span></footer>', unsafe_allow_html=True)
